...
Il existe plusieurs tests (graphiques, tests d'hypothèses, etc.) pour valider si un modèle est adéquat. Les 2 tests vus dans le cadre du cours sont le 

Souvent, certaines valeurs de ces tests peuvent aussi être utilisé pour comparer différents modèles entre-eux. 
